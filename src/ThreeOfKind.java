/*
 * This class calculates the score for the 3 of a kind category.
 * The 3 of a kind class extends the Roll abstract class.
 */
...
public class ThreeOfKind extends Roll
{
    public  int checkValues(int[] dice)
    {
        ...
        //Check if the roll is three ones
        if (d1==1 && d2==1 && d3==1)
        {
            sum = (d1+d2+d3+d4+d5);
        }

        //Check if the roll is three twos
        if ((d1==2 && d2==2 && d3==2) || (d2==2 && d3==2 && d4==2) || (d3==2 && d4==2 && d5==2))
        {
            sum = (d1+d2+d3+d4+d5);
        }

        //Check if the roll is three threes
        if ((d1==3 && d2==3 && d3==3) || (d2==3 && d3==3 && d4==3) || (d3==3 && d4==3 && d5==3))
        {
            sum = (d1+d2+d3+d4+d5);
        }

        //Check if the roll is three fours
        if ((d1==4 && d2==4 && d3==4) || (d2==4 && d3==4 && d4==4) || (d3==4 && d4==4 && d5==4))
        {
            sum = (d1+d2+d3+d4+d5);
        }

        //Check if the roll is three fives
        ...
        //Return the score for 3 of a kind
        return sum;
    }
